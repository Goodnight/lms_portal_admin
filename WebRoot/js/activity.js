...
//		}
	...
	$("#select").change( function () {
		...
		if(this_item=="多选题"){
			$(this).after('<label class="ml12" id="mostchoose"><input name="5" type="radio" value="" class="ace mr5"/><label class="lbl">最多可选<input name="optionCount" type="text" class="span2 w50" disabled="disabled" />项</label></label><label class="ml12" id="nolimit"><input name="5" type="radio" value=""  checked="checked" class="ace mr5"/><label class="lbl">不限</label></label>'); 	
		}
		else{
