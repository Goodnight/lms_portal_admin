...
$(function(){
	$(".btn_clean").click(function(){
		window.location = basepath + "/statistic/org.html";
	});
});
...
$('#btn_orgForm_submit').on('click', function () {
	...
	var d = $('#orgForm').serialize();
	var url = 'org/addreport.html';
	var fg=1;
...
$('#li_course').on('click', function () {
	$("#reporttype_id").val(1);

});
$('#li_doc').on('click', function () {
	$("#reporttype_id").val(2);

});
$('#li_case').on('click', function () {
	$("#reporttype_id").val(3);

});
$('#li_trainclass').on('click', function () {
	$("#reporttype_id").val(4);

});
$("#org_pager .page_max").change(function(){
	page(1);
});
...
function page(i){
	...
	var page_max = $("#org_pager .page_max").val();
	var max = page_max ? page_max : 10;

	var url = basepath + "/statistic/org.html";
