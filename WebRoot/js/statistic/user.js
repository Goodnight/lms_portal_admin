...
$(function(){
	...
	$(".btn_clean").click(function(){
		window.location = basepath + "/statistic/user.html";
	});
...
$('#btn_userform_submit').on('click', function () {
	var d = $('#userForm').serialize();
	var url = 'user/addreport.html';
	var flag=1;
...
$("#user_pager .page_max").change(function(){
	page(1);
});
...
function page(i){
	...
	var page_max = $("#user_pager .page_max").val();
	var max = page_max ? page_max : 10;

	var url = basepath + "/statistic/user.html";
