...
var tree_data_2 = {
	...
	'readme' : {name: '<i class="icon-file-alt blue"></i> ReadMe.txt', type: 'item'},
...
tree_data_2['documents']['additionalParameters'] = {
	'children' : [
		{name: '<i class="icon-file-alt red"></i> document1.pdf', type: 'item'},
		{name: '<i class="icon-file-alt grey"></i> document2.doc', type: 'item'},
		{name: '<i class="icon-file-alt grey"></i> document3.doc', type: 'item'},
		{name: '<i class="icon-file-alt red"></i> document4.pdf', type: 'item'},
		{name: '<i class="icon-file-alt grey"></i> document5.doc', type: 'item'}
	]
}

tree_data_2['backup']['additionalParameters'] = {
	'children' : [
		{name: '<i class="icon-suitcase brown"></i> backup1.zip', type: 'item'},
		{name: '<i class="icon-suitcase brown"></i> backup2.zip', type: 'item'},
		{name: '<i class="icon-suitcase brown"></i> backup3.zip', type: 'item'},
		{name: '<i class="icon-suitcase brown"></i> backup4.zip', type: 'item'}
	]
}
