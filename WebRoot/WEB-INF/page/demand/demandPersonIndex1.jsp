              ...
              <div class="page-right">
                  ...
                  <br />
                                ...
                                <tr>
                                    ...
                                    <td class="taR">&nbsp;&nbsp;&nbsp;类别&nbsp;</td>
                                    <td class="taL">
                                        <label class="option newR2" style="display: inline-block;">&nbsp;&nbsp;<input id="category" name="13" type="radio" value="0" class="ace" /><label class="lbl"></label>&nbsp;&nbsp;年度</label>
                                        <label class="option newR2" style="display: inline-block;">&nbsp;&nbsp;<input id="category" name="13" type="radio" value="1" class="ace" /><label class="lbl"></label>&nbsp;&nbsp;平时</label>
                                        <label class="option choosed newR2" style="display: inline-block;">&nbsp;&nbsp;<input id="category" name="13" type="radio" value="" class="ace"  /><label class="lbl"></label>&nbsp;&nbsp;不限</label>
                                    </td>
                                </tr>
                              	<tr>
                                <td class="taR">年度</td>
                                ...
                                <td class="taR">迫切性&nbsp;</td>
                                <td class="taL">
                                    <label class="option newR2" style="display: inline-block;"><input id="urgentLevel" type="radio" value="2" class="ace" /><label class="lbl"></label>&nbsp;&nbsp;迫切</label>
                                    <label class="option newR2" style="display: inline-block;"><input id="urgentLevel" type="radio" value="1" class="ace"/><label class="lbl"></label>&nbsp;&nbsp;一般</label>
                                    <label class="option newR2" style="display: inline-block;"><input id="urgentLevel" type="radio" value="0" class="ace"/><label class="lbl"></label>&nbsp;&nbsp;不迫切</label>
                                    <label class="option choosed newR2" style="display: inline-block;"><input id="urgentLevel" type="radio" value="" class="ace"/><label class="lbl"></label>&nbsp;&nbsp;不限</label>
                                </td>
                              </tr>
                                </table>
                                <div class="taR">
