...
<%@include file="/WEB-INF/page/include/taglibs.jsp"%>
        ...
        <div class="y w785">
            <div class="ngreyborder h470">
                <h5 class="png_bg">选择分配的培训班</h5>
                <div class="scroll h400 mt20">
                    <div class="searchblock m10">
                      <table border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td class="taR">培训班名称</td>
                            <td class="taL"><input id="name" type="text" class="input" style="margin-top:10px;" /></td>
                            <td class="taR">培训班状态</td>
                            <td class="taL">
                            	<select id="statusTrainClass" style="margin-top:10px;" >
                            ...
                            <div align="right" class="m10"><input name="" type="button" class="btn btn-small btn-info searchbutton" value="搜索" onclick="page(1)"/></div>
                  </div>
            ...
            <div class="taR m10">
            <div class="makesure">
                        <input id="addTrainClass" type="button" class=" btn btn-small btn-info step" value="确定"/>
...
$(function(){
    ...
    $("#addTrainClass").click(function(){
        ...
        for(var i=0;i<ids.length;i++){
            param += $(ids[i]).val()+",";
            var oText = $(ids[i]).parent().parent().parent().find("#className").text();
