		  	...
		  	<div class="headerco">
		     	<div class="breadCrumb reHeight noborder" id="breadCrumb3">
	                    <div class="z">
                               ...
                               <li><a href="${basepath }/trainclass/estimate.html?tcid=${tcId}">评估设置</a></li>
			...
			<div class="ngreyborder changeblue2 mt20">
				...
				<div class="courseupload2 pt15">
	            	<ul class="window_nav newnav">
           				<li class="basic"><a href="${basepath }/trainclass/behavior/new.html?sid=${sid}&tcid=${tcid}" class="png_bg">基本信息</a></li>
                   		<li class="course"><a href="#" class="green png_bg">安排人员</a></li>
	                </ul>
	               <div class="mt60">
	                	<div class="ml20">
	                		<label class="ml30 mr10">员工编号： <input id="search_user_sn" type="text" /></label>
	                		<label class="ml13 mr10">员工姓名： <input id="search_user_name" type="text" /></label>
	                		<label class="ml13 mr10">手机号码： <input id="search_user_mobile" type="text" /><!--只能输入数字--></label>
	                		<input class="searchbutton ml30" type="button" value="搜索"/>
	                	</div>
	                </div>
	                <c:if test="${upId!=tcid}">
		                <div class="taR mt20 mr10">
		                	<input type="button" class="functionbutton" id="btn_chooseperson" value="添加"/>
	                  		<input type="button" class="functionbutton" id="btn_import leadin" value="导入" />
	                  		<input type="button" class="functionbutton" id="btn_delete" value="删除" />
		                </div>
		             </c:if>
	                ...
	                <div align="right" class="mr10">
	                	...
	                	<a href="${basepath }/trainclass/estimate.html?tcid=${tcid}" class="step mr10 vm">完成</a>
	                </div>
	            </div>
			</div>
		</div>
