			...
			<div class="ngreyborder changeblue2 mt20">
				...
				<div class="courseupload2 pt15">
	            	<ul class="window_nav newnav">
           				<li class="basic"><a href="${basepath }/trainclass/response/new.html?sid=${sid}&tcid=${tcid}&symbol=${symbol}" class="png_bg">基本信息</a></li>
                   		<li class="course"><a href="javascript:;" class="green png_bg">安排人员</a></li>
	                </ul>
	                <div class="mt60 newsearch" style="padding-top:50px">
	                	<div class="ml20">
	                		<label class="ml30 mr10">员工编号： <input id="search_user_sn" type="text" class="input"/></label>
	                		<label class="ml13 mr10">员工姓名： <input id="search_user_name" type="text" class="input" /></label>
	                		<label class="ml13 mr10">手机号码： <input id="search_user_mobile" type="text"  class="input"/><!--只能输入数字--></label>
	                 ...
	                 <c:if test="${upId!=tcid}">
		                <div class="taR mt20 mr10">
		                	<a id="btn_chooseperson" href="#" class="functionbutton chooseperson">添加</a>
		                	<%--<a id="btn_import" href="#" class="functionbutton" id="leadin">导入</a>
