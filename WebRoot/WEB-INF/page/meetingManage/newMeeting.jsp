...
<div class="container">
  ...
  <div class="content cl">
		<div class="ngreyborder changeblue2 mt20">
        	<h2 class="png_bg">新建会议</h2>
        	<form id="meeting" action="saveMeeting.html" method="post">
            <div class="courseupload basic_information">
            	<ul class="window_nav newnav">
                    <li class="basic"><a href="newMeeting.html" class="png_bg">新建会议</a></li>
                ...
                <table border="0" cellspacing="15" cellpadding="15" class="mt40">
                	...
                	<tbody>
                    	<tr>
                        	...
                        	<td width="679"><input id="name" name="name" type="text" class="input vm"/>
                        	<div id="name_error" class="validate_error"></div>
                        	</td>
                        </tr>
                        <tr>
                        	<td class="taR"><em>*</em>开始时间</td>
                            <td><input id="startDate" name="start_date" type="text" class="input vm si" />
                            <select name="start_hour" id="start_hour" class="w50 ml12">
                            	<option>00</option>
                            	<option>01</option>
                            	<option>02</option>
                            	<option>03</option>
                            ...
                            <select name="start_minute" id="start_minute" class="w50 ml12">
                                <option>00</option>
                            	<option>05</option>
                            	<option>10</option>
                            	<option>15</option>
                            ...
                            <select name="start_second" id="start_second" class="w50 ml12">
                            	<option>00</option>
                            	<option>05</option>
                            	<option>10</option>
                            	<option>15</option>
                        ...
                        <tr>
                            ...
                            <td><input id="endDate" name="end_date" type="text" class="input vm si" />
                            <select id="end_hour" name="end_hour" class="w50 ml12">
                            	<option>00</option>
                            	<option>01</option>
                            	<option>02</option>
                            	<option>03</option>
                            ...
                            <select name="end_minute" id="end_minute" class="w50 ml12">
                                <option>00</option>
                            	<option>05</option>
                            	<option>10</option>
                            	<option>15</option>
                            ...
                            <select name="end_second" id="end_second" class="w50 ml12">
                                <option>00</option>
                            	<option>05</option>
                            	<option>10</option>
                            	<option>15</option>
                        ...
                        <tr>
                            ...
                            <td>
                                <input id="master_name"  name="master" type="text" value="${mb.master.name }" />
		                        <input id="master_id" name="master_name" type="hidden" value="${mb.master.uid }"/>
                            	<span id="master" class="vm chooseperson">选择主持人</span>
                        ...
                        <tr>
                            ...
                            <td>
                                <input id="teacher_name" name="teacher" type="text" value="${mb.teacher.name }" />
		                        <input id="teacher_id" name="teacher_name" type="hidden" value="${mb.teacher.uid }"/>
                            	<span id="teacher" class="vm chooseperson1">选择讲师</span>
                            	<div id="teacher_name_error" class="validate_error"></div>
                            </td>
                        </tr>
                        <tr>
                        	<td class="taR"><em>*</em>最大参会人员数</td>
                            <td><input id="maxAttend" name="maxAttend" type="text" class="input vm si" /><em>最多500人</em>
                        ...
                        <tr>
                            ...
                            <td><textarea name="remarks" id="remarks" cols="" ondblclick="clean()" rows=""  maxlength="1000">500字以内</textarea></td>
                        </tr>
                    </tbody>
                </table>
