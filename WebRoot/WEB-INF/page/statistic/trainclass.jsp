...
<html xmlns="http://www.w3.org/1999/xhtml" lang="utf-8" xml:lang="utf-8">
	...
	<body class="bg">
		       			...
		       			<div class="reHeight">
			            	<div class="newmain">
			                	<div class="newmainco">
                                    ...
                                    <div class="searchblock" style="margin-bottom:0">
		                                <table border="0" cellspacing="0" cellpadding="0">
		                                  <tr>
		                                    <td class="taR">培训班名称</td>
		                                    <td class="taL"><input type="text" class="input" name="trainCName" id="trainCName"/></td>
                                            <td class="taR">培训级别</td>
                                            <td class="taL"><select class="select" id="levelSpid" name="levelSpid">
											<option value="">全部</option>
											 <c:forEach items="${levelList}" var="level" varStatus="st">
											<option value="${level.spId}">${level.name}</option>
											 </c:forEach>
											</select>
											<input type="hidden" id="levelSpName" name="levelSpName" />
											</td>	
		                                    <td class="taR">培训类别</td>
		                                    <td class="taL"><select class="select" id="trainTSpId" name="trainTSpId">
											<option value="">全部</option>
											 <c:forEach items="${objectList}" var="type" varStatus="st">
											<option value="${type.spId}">${type.name}</option>
											 </c:forEach>
											</select>
											<input type="hidden" id="trainTSpName" name="trainTSpName" />
											</td>
                                            <td class="taR">培训方式</td>
                                            <td class="taL">  
											<select class="select" id="waySpId" name="waySpId">
											<option value="">全部</option>
											<c:forEach items="${wayList}" var="way" varStatus="st">
											<option value="${way.spId}">${way.name}</option>
											</c:forEach>
											</select>
											<input type="hidden" id="waySpName" name="waySpName" />
		                                  </tr>
                                            <tr>
		                               ...
		                               <div align="right" class="mt10">
										   <input id="btn_trainclassform_submit" name="" type="button" class="searchbutton m10" id="AddToStatistics" value="加入统计" hidefocus="true" style="height:30px;"/>
			                        ...
			                        <div class="mt20">
			                            <div class="dataTables_wrapper">
									 		<h3 class="reHeight">
				                            	<div class="z" style="font-size:14px;">培训班统计报表</div>
											...
											<table class="datatable" width="100%">
												...
												<tbody>
													...
													<c:choose>
														...
														<tr class="gradeA even">
													    <td><input name="jobId" type="checkbox" value="${d.jobId}" /></td>
													    <td><a href="${basepath }/ShowReport.wx?PAGEID=trainclassdetail&jobId=${d.jobId}" class="datacode2" target="_blank">队列创建的报表数据</a></td>
														</c:when>
													</c:choose>
		...
		<script type="text/javascript" src="${basepath }/js/statistic/trainclass.js" charset="utf-8"></script>
	</body>
</html>
