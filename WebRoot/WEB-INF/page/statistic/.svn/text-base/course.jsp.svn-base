...
<html xmlns="http://www.w3.org/1999/xhtml" lang="utf-8" xml:lang="utf-8">
	...
	<body class="bg">
		            		...
		            		<div>
				                ...
				                <div class="bigsearchblock">
				                    ...
				                    <div class="bigsearchco" style="border:0">
									 ...
									 <div align="right">
										<input id="btn_courseform_submit" name="" type="button" class="searchbutton m10" value="加入统计" hidefocus="true" style="height:30px;"/>
				                ...
				                <div class="dataTables_wrapper  mt20" style="width:99%">
		                            	<h3 class="reHeight">
			                            	<div class="z" style="font-size:14px;">课程学习信息统计报表</div>
											...
											<thead>
											  ...
											  <c:forEach items="${rows}" var="d" varStatus="st">
													<c:choose>
															...
															<tr class="gradeA even">
															<td><input name="jobId" type="checkbox" value="${d.jobId}" /></td>
															<td><a href="${basepath }/ShowReport.wx?PAGEID=courselearn&jobId=${d.jobId}" class="datacode2" target="_blank">队列创建的报表数据</a></td>
															</c:when>
														</c:choose>
													<td>${d.describes}</td>
													<td>${username}</td>
		...
		<script type="text/javascript" src="${basepath }/js/statistic/course.js" charset="utf-8"></script>
