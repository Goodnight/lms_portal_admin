...
<body class="bg">
	<form id="form1">
		<input type="hidden" id="importType" name="importType"
			value="comprehensiveUser" /> <input type="hidden" id="objId" name="objId"
			value="${sid}" />
	</form>
	...
	<div class="container">
				...
				<div class="breadCrumb reHeight noborder" id="breadCrumb3">
					<div class="z">
						<ul>
							...
							<li><a href="${basepath }/survey/index.html?type=4">综合评估</a></li>
		...
		<div class="content cl">
			<div class="ngreyborder changeblue2 mt20">
				<h2 class="png_bg">综合评估 - 安排人员</h2>
				<div class="courseupload2 pt15">
					<ul class="window_nav newnav">
						<li class="basic"><a href="${basepath }/survey/new.html?type=4&sid=${sid}&symbol=${symbol}" class="png_bg">基本信息</a></li>
						<li class="course"><a href="javascrip:;" class="green png_bg">安排人员</a></li>
					</ul>
					<form id="query_form">
						<div class="mt60 newsearch" style="padding-top: 50px">
							<div class="ml20">
								<label class="ml30 mr10">员工编号： <input
									id="search_user_sn" name="search_user_sn" type="text"
									class="input" /></label> <label class="ml13 mr10">员工姓名： <input
									id="search_user_name" name="search_user_name" type="text"
									class="input" /></label> <label class="ml13 mr10">手机号码： <input
									id="search_user_mobile" name="search_user_mobile" type="text"
									class="input" />
					...
					<div class="taR mt20 mr10">
						<a id="btn_chooseperson" href="#"
							class="functionbutton">添加</a> <a href="#"
							class="functionbutton" id="leadin">导入</a><a id="btn_delete"
							href="#" class="functionbutton">删除</a>
					</div>
					...
					<div align="right" class="mr10">
						<input id="sid" type="hidden" name="sId" value="${sid }" /> <input
							id="stype" type="hidden" name="type" value="4" /> <a
							href="${basepath }/survey/index.html?type=4" class="step mr10 vm">完成</a>
					</div>
				</div>
			</div>
		</div>
