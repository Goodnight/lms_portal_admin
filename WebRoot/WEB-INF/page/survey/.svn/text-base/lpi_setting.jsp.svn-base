	...
	<div class="container">
		  	...
		  	<div class="headerco">
		     	<div class="breadCrumb reHeight noborder" id="breadCrumb3">
	                    <div class="z">
                               ...
                               <li><a href="${basepath }/behavior/index.html?type=3">LPI测评</a></li>
		...
		<div class="content cl">
			<div class="ngreyborder changeblue2 mt20">
				<h2 class="png_bg">LPI测评 - 安排人员</h2>
				<div class="courseupload2 pt15">
	            	<ul class="window_nav newnav">
           				<li class="basic"><a href="${basepath }/survey/new.html?type=3&sid=${sid}" class="png_bg">基本信息</a></li>
	                ...
	                <div class="taR mt20 mr10">
	                	<input type="button" class="functionbutton" id="btn_chooseperson" value="添加"/>
                  		<input type="button" class="functionbutton leadin" value="导入" />
	                ...
	                <div align="right" class="mr10">
	                	...
	                	<a href="${basepath }/behavior/index.html?type=3" class="step mr10 vm">完成</a>
	                </div>
	            </div>
			</div>
		</div>
