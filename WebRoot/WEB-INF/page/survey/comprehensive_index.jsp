...
<body class="bg">
<form id="form1">
	<input type="hidden" id="importType" name="importType" value=comprehensiveResult />
	                	...
	                	<div class="newmainco">
	                        ...
	                        <div>
	                            ...
	                            <div class="dataTables_wrapper">
	                            	<h3 class="reHeight">
		                            	<div class="z">综合评估</div>
		                                <div class="y">
		                                	<a href="${basepath }/survey/new.html?type=4" class="functionbutton">新建</a>
...
<script type="text/javascript" src="${basepath }/js/estimate/survey.js" charset="gbk"></script>
