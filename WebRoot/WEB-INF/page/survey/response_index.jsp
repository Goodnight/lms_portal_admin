...
<body class="bg">
<form id="form1">
	<input type="hidden" id="importType" name="importType" value=responseResult />
	                	...
	                	<div class="newmainco">
	                        ...
	                        <div class="classlist">
	                            ...
	                            <div class="dataTables_wrapper">
	                            	<h3 class="reHeight">
		                            	<div class="z">反应层评估</div>
		                                <div class="y">
		                                	<a href="${basepath }/survey/new.html?type=1" class="functionbutton">新建</a>
