            ...
            <div class="searchblock pl10 w92p">
				<table border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td class="taR">奖励方式</td>
                        <td class="taL">
						<label class="autowidth">
						<span class="option choosed">
						<input name="gainType" type="radio" value="" checked="checked"/>
						</span>
						 不限</label>
						 <c:forEach items="${gainList}" var="g">
						 <label class="autowidth">
						 <span class="option">
						 <input name="gainType" type="radio" value="${g.spId}" />
						 </span>
						  ${g.name }
						  </label>
			              </c:forEach>
...
<script type="text/javascript" src="${basepath }/js/score/scoreUserGain.js" charset="gbk"></script>
<script type="text/javascript" src="${basepath }/js/score/uplodScoreUserGain.js" charset="gbk"></script>
