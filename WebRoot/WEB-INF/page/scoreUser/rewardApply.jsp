...
<div class="container">
  ...
  <div class="content cl">
                        	...
                        	<col width="25%" />       
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="taR">部门</td>
                                        <td>${scoreUserCost.user.dep.name }</td>	
                                    </tr>
                                    <tr>
        ...
        <div align="right"><input name="" type="button" class="step vm m10" value="批准" /><input name="" type="button" class="step vm m10" value="不批准" /><a href="${basepath }/rewardScoreUser/scoreUserApplyCostList.html" class="back m10 vm">关闭</a></div>
    </div>
