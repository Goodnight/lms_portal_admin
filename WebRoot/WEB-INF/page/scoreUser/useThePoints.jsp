...
<div class="newwindow hidden" id="leadinco">
    ...
    <div class="ngreyborder changeblue2 mt20">
        	<h2 class="png_bg">导入使用积分</h2>
            <div class="basic_information w90p">
              <div class="pt20">导入使用积分：<input name="" type="file" /> <a href="" class="ml30">下载导入模板 <img src="${basepath }/images/download.png" width="16" height="16" class="vm"/></a></div>
		...
		<div class="ngreyborder changeblue2 mt20">
            ...
            <div class="searchblock pl10 w92p">
				<table border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td class="taR">使用时间</td>
                        <td class="taL"><input type="text" class="timetext" id="search_start_date" name="begin_time"/><em>到</em><input type="text" class="timetext" id="search_end_date" name="end_time"/></td>
                    
                   
                    <td class="taR">兑换方式</td>
                        <td class="taL">
						<label class="autowidth">
						<span class="option choosed">
						<input name="costType" type="radio" value="" checked="checked"/>
						</span>
						 不限
						 </label>
						 ...
						 <label class="autowidth">
						 <span class="option">
						 <input name="costType" type="radio" value="${r.spId}" />
						 </span>
						  ${r.name }
						  </label>
			              </c:forEach>
...
<script type="text/javascript" src="${basepath }/js/score/scoreUserCost.js" charset="gbk"></script>
