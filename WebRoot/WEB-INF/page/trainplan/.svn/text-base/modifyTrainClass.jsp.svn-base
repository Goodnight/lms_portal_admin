...
<jsp:include page="/WEB-INF/page/include/header.jsp"></jsp:include>
  ...
  <div class="content cl">
		<div class="ngreyborder changeblue2 mt20">
        	<h2 class="png_bg">修改培训班</h2>
			<form id="trainplanclass" action="saveChangedTrainClass.html" method="post">
            <div class="basic_information mt2">
                	...
                	<tbody>
                    	<tr>
                        	<td><em>*</em>名称：</td>
                            <td colspan="3">
                                <input name="name" type="text" class="input vm" value="${trainClass.name }" />
                                <input name="id" id="id" type="hidden" value="${p.tpId }"/>
                                <input name="tcId" id="tcId" type="hidden" value="${trainClass.tcId }"/>
                            </td>
                        </tr>
                        <tr>
                        	<td><em>*</em>预期举办时间：</td>
                            <td>
                            <c:if test="${trainClass.expectStartQuarter == 1}">
                            	<label><input name="expectStartQuarter" type="radio" value="1" class="vm mr5" checked="checked" />第一季度</label>
                            ...
                            <c:if test="${trainClass.expectStartQuarter == 2}">
                                <label><input name="expectStartQuarter" type="radio" value="1" class="vm mr5"/>第一季度</label>
                                <label><input name="expectStartQuarter" type="radio" value="2" class="vm mr5" checked="checked" />第二季度</label>
                                <label><input name="expectStartQuarter" type="radio" value="3" class="vm mr5"/>第三季度</label>
                                <label><input name="expectStartQuarter" type="radio" value="4" class="vm mr5"/>第四季度</label>
                            </c:if>
                            <c:if test="${trainClass.expectStartQuarter == 3}">
                                <label><input name="expectStartQuarter" type="radio" value="1" class="vm mr5"/>第一季度</label>
                                <label><input name="expectStartQuarter" type="radio" value="2" class="vm mr5"/>第二季度</label>
                                <label><input name="expectStartQuarter" type="radio" value="3" class="vm mr5" checked="checked" />第三季度</label>
                                <label><input name="expectStartQuarter" type="radio" value="4" class="vm mr5"/>第四季度</label>
                            </c:if>
                            <c:if test="${trainClass.expectStartQuarter == 4}">
                                <label><input name="expectStartQuarter" type="radio" value="1" class="vm mr5"/>第一季度</label>
                                <label><input name="expectStartQuarter" type="radio" value="2" class="vm mr5"/>第二季度</label>
                                <label><input name="expectStartQuarter" type="radio" value="3" class="vm mr5"/>第三季度</label>
                                <label><input name="expectStartQuarter" type="radio" value="4" class="vm mr5" checked="checked" />第四季度</label>
                            </c:if>
                            </td>
                            <td><em>*</em>编号：</td>
                            <td><input name="sn" type="text" value="${trainClass.sn }" readonly="readonly" /></td><!-- 20130407 计划中培训班编号修改为自动生成 by LTC -->
                        </tr>
                        <tr>
                        	<td><em>*</em>培训级别：</td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td><em>*</em>期数：</td>
                            <td><input name="timesNum" type="text" value="${trainClass.timesNum }" maxlength="5" /></td>
                        </tr>
                        <tr>
                        	<td>地点：</td>
                            <td colspan="3"><input name="address" type="text" value="${trainClass.address }" maxlength="15" /></td>
                        </tr>
                        <tr>
                        	<td><em>*</em>每期天数：</td>
                            <td><input name="trainDuration" type="text" value="${trainClass.trainDuration }" maxlength="5" /></td>
                            <td><em>*</em>每期人数：</td>
                            <td><input name="attendNum" type="text" value="${trainClass.attendNum }" maxlength="5" /></td>
                        </tr>
                        <tr>
                        	<td><em>*</em>主办部门：</td>
                            <td>
                        ...
                        <tr>
                        	<td><em>*</em>培训开始日期：</td>
                            <td><input id="start_date" name="start_date" type="text" class="input vm si" value="${trainClass.start_date }" readonly="readonly" /></td>
                            <td><em>*</em>培训结束日期：</td>
                            <td><input id="end_date" name="end_date" type="text" class="input vm si" value="${trainClass.end_date }" readonly="readonly" /></td>
                        </tr>
                        <tr>
                        	<td>培训计费方式：</td>
                            <td colspan="3">
                        ...
                        <tr>
                        	<td>培训费用预算：</td>
                            <td><input name="budget_train" type="text" value="${trainClass.budget_train }" maxlength="8" /></td>
                            <td>食宿费用预算：</td>
                            <td><input name="budget_board" type="text" value="${trainClass.budget_board }" maxlength="8" /></td>
                        </tr>
                        <tr>
                        	<td class="vt"><em>*</em>培训对象</td>
                            <td colspan="3"><textarea name="trainObeject" class="lengthRestrict" cols="" rows="">${trainClass.trainObject }</textarea></td>
                        </tr>
                        <tr>
                        	<td class="vt"><em>*</em>培训内容</td>
                            <td colspan="3"><textarea name="content" class="lengthRestrict" cols="" rows="">${trainClass.content }</textarea></td>
                        </tr>
                        <tr>
                        	<td class="vt"><em>*</em>培训目的</td>
                            <td colspan="3"><textarea name="planPurpose" class="lengthRestrict" cols="" rows="">${trainClass.purpose }</textarea></td>
                        </tr>
                    </tbody>
                </table> 	
...
<script type="text/javascript">
	...
	var id = "${p.tpId}";
	//$("textarea.lengthRestrict").keydown(function(event){
