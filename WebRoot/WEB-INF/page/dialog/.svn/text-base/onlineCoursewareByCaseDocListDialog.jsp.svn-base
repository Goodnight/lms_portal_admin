 ...
 <div>
        	<div class="ngreyborder changeblue">
                ...
                <div class="courselist">
                    ...
                    <!-- 课程列表 -->
                    <div id="onlineCoursewareByCaseDocList_list"></div>
...
<script type="text/javascript">
	...
	function page(i){
		var url = basepath + "/list/resource/onlineCoursewareByCaseDocList.html?pagefn=page&page="+i+"&r="+Math.random();
		$("#onlineCoursewareByCaseDocList_list").load(encodeURI(url),function(){
			//禁用已经选择的选项
	...
	var url = basepath + "/list/resource/onlineCoursewareByCaseDocList.html?pagefn=page&page="+i+"&r="+Math.random();
		$("#onlineCoursewareByCaseDocList_list").load(encodeURI(url+query),function(){
			//禁用已经选择的选项
			var cbList = $("input:checkbox[name=rdId]");
			var ctList = $("input[name=choosedCourse]");
			if(cbList.length>0 && ctList.length>0){
