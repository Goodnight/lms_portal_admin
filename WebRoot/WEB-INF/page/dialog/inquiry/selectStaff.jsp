    ...
    <div class="cl scroll">
        ...
        <div class="y w750">
          ...
          <div class="choosedcourse" style="margin-top:40px;">	
                 	<div class="mt20">
                 		<span class="mr10 ml13">员工编号： <input type="text" class="input" style="border:1px solid;"/></span>
                 		<span class="mr10">员工姓名： <input type="text" class="input" style="border:1px solid;"	/></span>
                 		<span class="ml30">包含子部门：<select name=""><option>不包含</option><option>包含</option></select></span>
                 	</div>
