        	...
        	<div class="ngreyborder changeblue">
                ...
                <div class="courselist">
                    <ul class="png_bg">
                     ...
                     <!-- 文档列表 -->
                    <div id="onlineDocByDocList_list"></div>
...
<script type="text/javascript">
	...
	function page(i){
		var url = basepath + "/list/resource/onlineDocByDocList.html?pagefn=page&page="+i+"&r="+Math.random();
		$("#onlineDocByDocList_list").load(encodeURI(url),function(){
			//禁用已经选择的选项
...
function selectDocBottonClick(i){
	...
	query+="&isChildOrg="+isChildOrg;
		var url = basepath + "/list/resource/onlineDocByDocList.html?pagefn=page&page="+i+"&r="+Math.random();
		$("#onlineDocByDocList_list").load(encodeURI(url+query),function(){
			//禁用已经选择的选项
			var cbList = $("input:checkbox[name=rdId]");
			var ctList = $("input[name=choosedDoc]");
			if(cbList.length>0 && ctList.length>0){
