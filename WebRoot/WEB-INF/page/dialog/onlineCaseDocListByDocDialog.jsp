        	...
        	<div class="ngreyborder changeblue">
                ...
                <div class="courselist">
                    <ul class="png_bg">
                     ...
                     <!-- 案例列表 -->
                    <div id="onlineCaseDocByDocList_list"></div>
...
<script type="text/javascript">
	...
	function page(i){
		var url = basepath + "/list/resource/onlineCaseDocByDocList.html?pagefn=page&page="+i+"&r="+Math.random();
		$("#onlineCaseDocByDocList_list").load(encodeURI(url),function(){
			//禁用已经选择的选项
...
function selectCaseDocBottonClick(i){
	...
	var url = basepath + "/list/resource/onlineCaseDocByDocList.html?pagefn=page&page="+i+"&r="+Math.random();
		$("#onlineCaseDocByDocList_list").load(encodeURI(url+query),function(){
			//禁用已经选择的选项
			var cbList = $("input:checkbox[name=rdId]");
			var ctList = $("input[name=choosedCaseDoc]");
			if(cbList.length>0 && ctList.length>0){
