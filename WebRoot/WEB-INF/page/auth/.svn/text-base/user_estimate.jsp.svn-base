...
<body class="bg">
    ...
    <div class="content">
        ...
        <div class="searchblock pt15 reHeight">
         ...
         <li ><a href="${basepath}/user/documetForAll.html?op=cours&uid=${uid}">在线课程</a></li>
           ...
           <!--  <li><a href="javascipt:;">考试</a></li>
            ...
            <li class="now"><a href="${basepath}/user/documetForAll.html?op=estimate&uid=${uid}">调查评估</a></li>
          </ul>
        </div>
      </div>
      <!-- /dpnav -->
      ...
      <div class="train-search">
        ...
        <table border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td class="taR">年份</td>
            <td class="taL">
              <select id="estYear" onchange="javascript:selectForEstimate(1)" class="select">
                <option>全部</option>
                <option>2012</option>
                <option>2013</option>
                <option>2014</option>
      ...
      <div name="list_documetForEstimate" id="list_documetForEstimate"></div>
  ...
  <script type="text/javascript" src="${basepath}/js/demand/documentForEstimate.js"></script>
