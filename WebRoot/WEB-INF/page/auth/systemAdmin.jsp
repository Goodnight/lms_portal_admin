...
<jsp:include page="/WEB-INF/page/include/header.jsp"></jsp:include>
  <div class="content cl">
        <div class="ngreyborder2 changeblue2 mt20">
            <h2 class="png_bg">系统管理员</h2>
            <div class="dataTables_wrapper mt40">
                                <div class="reHeight">
                                ...
                                <table class="datatable" width="100%">
                                    <thead>
                                        <tr>
                                              <th class="taL pl10">已有权限</th>
                                        </tr>
                                      </thead>
                                      <tbody>
                                        <tr class="gradeA odd">
                                            <td class="taL pl10">资源：数据管理－教师管理－外聘教师信息 权限：具备权限，高级管理</td>
                                         </tr>
