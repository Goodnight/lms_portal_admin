		...
		<div class="ngreyborder changeblue2 mt20">
            ...
            <div class="courseupload basic_information">
            	<ul class="window_nav newnav">
                    <li class="basic"><a href="tosaveCoursewareDetails.html" class="green png_bg">基本信息</a></li>
                    <li class="course"><a href="toCoursewareResources.html" class="png_bg">关联资源</a></li>
                </ul>
                <h3 class="mt40">讲义/大纲</h3>
          		<table border="0" cellspacing="15" cellpadding="15">
                	...
                	<tbody>
                    	<tr>
                        	...
                        	<td colspan="3"><input name="" type="file" /> <input type="button" value="确定" /></td>    	
                        </tr>
                        <tr>
                        	<td><em>*</em>课程讲义：</td>
              ...
              <h3 class="mt40">资源</h3>
                ...
                <div class="reHeight taR mr10 mt10">
                    <p><a href="javascript:;" class="functionbutton addClass" id="add_courseware" hidefocus="true">关联课程</a><a href="javascript:;" id="add_doc" class="functionbutton addDocument" hidefocus="true">关联文档</a><a href="javascript:;" id="add_caseDoc" hidefocus="true" class="functionbutton addCase">关联案例</a><input id="btn_delete_online" type="button" class="functionbutton" value="取消关联"/></p>
                </div>
                
              <div class="dataTables_wrapper" style="padding-bottom:0">
                            	<div class="reHeight">
                            	<div class="dataTables_length"><label class="reHeight"><div class="z pt10">每页显示</div><div class="selector z" id="uniform-undefined"><span style="-moz-user-select: none;">10</span><select size="1" style="opacity: 0;" id="page_max"><option value="10" selected="selected">10</option><option value="25">25</option><option value="50">50</option><option value="100">100</option></select></div><div class="z pt10">条</div></label></div>
                                </div>
                            <div>
                ...
                <div class="taR">
    			<p><input name="" type="button" class="step m10 vm"   value="上一步" hidefocus="true" onClick="location.href='javascript:history.go(-1);'" />
    			<a href="#" class="back m10 vm allclose">关闭</a></p>
    		</div>
...
<script type="text/javascript" src="${basepath }/js/res/coursewareResources.js" charset="gbk"></script>
</body>
</html>
