...
<body class="bg">
						...
						<div class="newmain">
							<div class="newmainco">
								<ul class="dpnav2 m10 reHeight">
									...
									<li class="now"><a
										href="${basepath }/doc/docList.html?docType=0">文档</a></li>
									...
									<table border="0" cellspacing="0" cellpadding="0">
										...
										<tr>
											...
											<td colspan="3" class="taL"><input name="name"
												type="text" class="inputtext" value="输入文档名称" id="name" /> <input
	...
	<script type="text/javascript" src="${basepath }/js/res/doc.js"
		charset="gbk"></script>
