...
<body class="bg">
							...
							<div class="newmainco">
									...
									<table border="0" cellspacing="0" cellpadding="0">
										...
										<tr>
											...
											<td class="taL"><input id="name" type="text"
												class="input" name="name" value="" /></td>
										...
										<tr>
											...
											<td class="taL"><input name="startDt" type="text"
												class="timetext" id="search_start_date" /><em
								...
								<div>
									<div class="dataTables_wrapper">
										...
										<!-- 精品资源列表 -->
										<div id="list_libraryResList"></div>
									</div>
								</div>
							</div>
						</div>
	...
	<script type="text/javascript" src="${basepath }/js/res/libraryRes.js"
		charset="gbk"></script>
	<script type="text/javascript">
