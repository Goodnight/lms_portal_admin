...
<html xmlns="http://www.w3.org/1999/xhtml" lang="utf-8" xml:lang="utf-8">
	...
	<body class="bg">
							...
							<div class="newmain">
								<div class="newmainco">
									<ul class="dpnav2 m10 reHeight">
                                        ...
                                        <li class="now">文档</li>
                                        <li><a href="${basepath }/case/caseDocList.html?docType=1">案例</a></li>
									</ul>
									<div class="searchblock">
										<table border="0" cellspacing="0" cellpadding="0">
											
											<tr>
                                <td class="taR">文档名称</td>
                                <td colspan="3" class="taL"><input name="name" type="text" class="inputtext" value="输入文档名称" id="name" />
									...
									<div>
										<div class="dataTables_wrapper">
											<div class="reHeight mt20">
												<div class="z">
													<em><a href="docList.html"><img src="${basepath }/images/list.jpg" width="26" height="22" /></a><img src="${basepath }/images/picturenow.jpg" width="27" height="22"/></em>
												</div>
												<div class="z"><input name="" type="checkbox" value="" class="checkbox ml13" onclick="checkAll('groupTypeId')"/>全选</div>
												<div class="y">
													<a href="javascript:;" class="functionbutton" id="btn_jh">精品</a><a href="javascript:;" class="functionbutton" id="btn_ls">历史</a><a href="tosaveDocDetails.html" class="functionbutton">新建</a><a href="javascript:;" class="functionbutton leadout">导出</a><a href="javascript:;"  class="functionbutton" id="btn_delete">删除</a>
												</div>
											</div>
												<div class="reHeight">
		...
		<script type="text/javascript" src="${basepath }/js/res/docPic.js" charset="gbk"></script>
