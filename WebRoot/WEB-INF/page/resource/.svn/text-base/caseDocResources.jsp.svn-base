...
<div class="container">
  ...
  <input id="rdId" name="rdId" type="hidden" value="${rdId }"/>
		<div class="ngreyborder changeblue2 mt20">
        	<h2 class="png_bg">新建案例</h2>
            <div>
            	<ul class="window_nav newnav">
                    <li class="basic"><a href="tosaveCaseDocDetails.html" class="green png_bg">基本信息</a></li>
                    <li class="course"><a href="toCaseDocResources.html" class="png_bg">关联资源</a></li>
                </ul>
                <div class="reHeight mt40 taR mr10">
                   <p class="mt40"><a href="javascript:;" class="functionbutton addClass" id="add_courseware" hidefocus="true">关联课程</a><a href="javascript:;" class="functionbutton addDocument" id="add_doc" hidefocus="true">关联文档</a><a href="javascript:;" class="functionbutton addCase" id="add_caseDoc" hidefocus="true">关联案例</a><input id="btn_delete_online" type="button" class="functionbutton" value="删除"/></p>
                </div>
...
<script type="text/javascript" src="${basepath }/js/res/caseDocResources.js" charset="gbk"></script>
</body>
</html>
