	...
	<div class="ngreyborder mt10" style="background:#fff;">
                ...
                <div class="scroll">               
                	...
                	<tbody>
                        ...
                        <tr>
                            <td>有效期</td>
                            <td><input name="" type="text" class="input vm time" /></td>
                        </tr>
                        <tr>
                        	<td>奖励类别：</td>
                            <td>
  ...
  <div class="content cl">
		<div class="ngreyborder changeblue2 mt20">
            ...
            <div class="mt10">
                ...
                <div id="list_scoreDepGainList"><div>
...
<script type="text/javascript" src="${basepath }/js/score/scoreDepGain.js" charset="gbk"></script>
<script type="text/javascript">
	var depId = "${depId}";
</script>
