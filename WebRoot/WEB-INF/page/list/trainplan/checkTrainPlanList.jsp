...
<table class="datatable" width="100%">
	...
	<tbody>    
		...
		<td> ${t.year}</td>
		<td><a id="${t.tpId }" href="#" class="showInfo">${t.name }</a></td>
        <td>
            <c:choose>
		...
		<td><a href="viewPlanClass.html?id=${t.tpId }&ban=1&symbol=2" >${t.trainClassNum }</a></td>
        <td>
           <a id="status_${t.tpId }" href="javascript:changeStatus(${t.status },'${t.tpId }','${pageNo }');">
              <c:choose>
...
$(".showInfo").click(function(){
    var url = basepath+"/trainplan/viewCheckTrainPlan.html?id="+$(this).attr("id");
