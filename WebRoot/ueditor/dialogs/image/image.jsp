...
<head>
    ...
    <link rel="stylesheet" href="${basepath }/ueditor/dialogs/image/image.css" type="text/css" />
</head>
	<body>
    <div class="wrapper">
        <div id="imageTab">
    ...
    <script type="text/javascript" src="${basepath }/ueditor/dialogs/tangram.js"></script>
    <script type="text/javascript" src="${basepath }/ueditor/dialogs/image/image.js"></script>
